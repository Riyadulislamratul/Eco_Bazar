...
const CategoryCard = ({ image, title, products }) => {
  return (
    <div
      className="group cursor-pointer rounded-lg border border-gray-200 bg-white p-6 transition-all duration-300 hover:border-green-500 hover:shadow-xl w-50 h-53.25"
    >
      {/* Image */}
