        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="rounded-lg bg-white shadow-xl p-10">
            ...
            <form className="space-y-5">
              ...
              <button className="w-full rounded-full bg-green-600 py-3 font-semibold text-white hover:bg-green-700 duration-300">
                Login
              </button>
            ...
            <p className="text-center text-sm mt-8 text-gray-600">
              Don't have account?
              <button className="font-semibold ml-1 hover:text-green-600">
                Register
              </button>
            </p>
